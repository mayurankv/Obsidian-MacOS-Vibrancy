...
[![Downloads](https://img.shields.io/badge/dynamic/json?logo=obsidian&color=%23483699&label=downloads&style=for-the-badge&query=%24%5B%22macos-vibrancy%22%5D.downloads&url=https%3A%2F%2Fraw.githubusercontent.com%2Fobsidianmd%2Fobsidian-releases%2Fmaster%2Fcommunity-plugin-stats.json)](https://obsidian.md/plugins?id=macos-vibrancy)
...
- Alternatively you can just copy over `main.js`, `styles.css`, `manifest.json` to your vault `VaultFolder/.obsidian/plugins/macos-vibrancy/` or use the [Obsidian Beta Reviewers Plugin](https://github.com/TfTHacker/obsidian42-brat).
...
[![List of contributors](https://contrib.rocks/image?repo=mayurankv/Obsidian-MacOS-Vibrancy)](https://github.com/mayurankv/Obsidian-MacOS-Vibrancy/graphs/contributors)
